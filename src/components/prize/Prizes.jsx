            ...
            <Row align={"middle"} justify={"center"} gutter={[16, 16]}>
                <Col span={24} lg={12}>
                    <Flex vertical align={"center"} justify={"center"} style={{width: '100%'}} gap={"small"}>
                        <img src={firstPrizeLogo} alt={'first-prize-logo'} width={'50%'} height={'auto'}/>
                ...
                <Col span={24} lg={12}>
                    <Flex vertical align={"center"} justify={"center"} style={{width: '100%'}} gap={"small"}>
                        <img src={secondPrizeLogo} alt={'second-prize-logo'} width={'50%'} height={'auto'}/>
                ...
                <Col span={24} lg={12}>
                    <Flex vertical align={"center"} justify={"center"} style={{width: '100%'}} gap={"small"}>
                        <img src={thirdPrizeLogo} alt={'third-prize-logo'} width={'50%'} height={'auto'}/>
